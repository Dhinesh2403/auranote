...
//   window.__ENV = { AURA_ENDPOINT: "https://...", AURA_API_KEY: "..." };
//
...
//    or host an env script that sets `window.__ENV.AURA_ENDPOINT` and `window.__ENV.AURA_API_KEY` before the app loads.
